    ...
    private final class UsbHandler extends Handler {
        ...
        public UsbHandler(Looper looper) {
            ...
            try {
				...
				// patched by Str1ker, 07.11.2016
                //String value = SystemProperties.get("persist.service.adb.enable", "");
				//boolean IsAdbEnabledBug347 = false;
                //if (value.length() > 0) {
                //   char enable = value.charAt(0);
                //    if (enable == '1') {
                //       IsAdbEnabledBug347 = true;
                //    }
                //}
				//setAdbEnabled(IsAdbEnabledBug347);
                //SystemProperties.set("persist.service.adb.enable", IsAdbEnabledBug347 ? "1" : "0");
				//Slog.w(TAG, "persist.service.adb.enable switched to " + IsAdbEnabledBug347);
				// end of patch
